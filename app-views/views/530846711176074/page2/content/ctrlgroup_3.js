              ...
              on: {
                click: function(elem) {
                  if (!isFlag) {
                    ...
                    var alertItemList = params.variables.alertItemList;
                    params.taskStatus = 200;
                    params.values = {
                      "alertEvaluateInfoList": alertItemList,
                      "diagnoseDeclare": target.getValue("diagnoseDeclare"),
                    }

                    function requiredFields() {
                      if (params.values.diagnoseDeclare == undefined || params.values.diagnoseDeclare == "") {

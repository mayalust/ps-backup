            ...
            var loopformat = function (inx, colInx, fmtInx, fmt) {
              columns.push({
                ...
                render: function (data, type, full) {
                  ...
                  var createZhanJiangStatus = function () {
                    //var span = $("<span></span>").addClass("label label-info");
                    var span = $("<span></span>").addClass("label");
                    span.attr("fmtInx", fmtInx);
                    if (data == 0 || data == -100) {
                      span.text("待诊断").addClass("label-info");
                    } else if (data == 5) {
                      span.text("已确认").addClass("label-primary");
                    } else if (data == 10) {
                      // span.text("处理中").addClass("label-warning");  宝钢处理中也显示成已确认状态
                  ...
                  if (type == "text") {
                    ...
                    dom = createStatus();
                  } else if (type == "statusZhanJiang") {
                    dom = createZhanJiangStatus();

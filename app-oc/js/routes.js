  ...
  return {
    ...
    routes: {
      ...
      '/configmanager': {
        ...
        dependencies: ['js/controllers/configmanager-ctrl.js', 'js/directives/configmanager-dom.js', 'js/directives/treeview-dom.js', '../js/directives/tools-dom.js', '../js/directives/fb-tools-dom.js']
      },
      '/dashboard/:page?/:parameter?': {
        ...
        dependencies: ['../js/controllers/dashboard-ver3-ctrl.js', '../js/directives/free-board-dom.js','../js/directives/tools-dom.js', '../js/directives/fb-tools-dom.js']
      },
      '/views/:viewType/:viewId?': {
        templateUrl: 'partials/dashboardmanagement.html',
        controller: 'dashboardmanageCtrl',
        dependencies: ['js/controllers/dashboard-management-ctrl.js', '../js/directives/free-board-dom.js', '../js/directives/data-tables-dom.js', '../js/directives/tools-dom.js', '../js/directives/fb-tools-dom.js']
      },
      ...
      '/orderdetail/:id/:workType/:state': {
        templateUrl: 'partials/orderdetail.html',
        controller: 'orderDetailCtrl',
        dependencies: ['js/controllers/workorder-record-ctrl.js', 'js/directives/workorder-record-dom.js', '../js/directives/timeline-dom.js']
      },
      '/resource': {
      ...
      /* '/resource_type': {
         ...
         dependencies: ['../js/controllers/view-cmdb-dev-ctrl.js', '../js/directives/tools-dom.js',
           '../js/directives/attr-dom.js', '../js/directives/device-version-dom.js', '../js/directives/kpi-dom.js', '../js/directives/alert-simple-dom.js', 'js/directives/treeview-dom.js', '../js/directives/directives-dom.js'
         ]
       },*/
      '/resource_type': {
      ...
      '/usermanager/permission/:panel/:roleID': {
        ...
        dependencies: ['js/controllers/permission_ctrl.js', '../js/directives/data-tables-dom.js', '../js/directives/tree-view-dom.js', '../js/directives/select-list-dom.js', '../js/directives/fb-tools-dom.js']
      },
      /**
      '/usermanager': {
        templateUrl: 'partials/usermanager_list.html',

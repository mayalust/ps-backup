define(['controllers/controllers', 'bootstrap-dialog'], function (controllers, BootstrapDialog) {
  'use strict';
  controllers.initController('processViewsCtrl', ['$scope','ngDialog', 'workflowService', 'workflowDefinitionService', 'viewFlexService', '$timeout', 'growl',
    function ($scope,ngDialog, workflowService, workflowDefinitionService, viewFlexService, $timeout, growl) {

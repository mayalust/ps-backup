define(['controllers/controllers', 'Array'], function (controllers) {
  'use strict';
  controllers.initController('UserListCtrl', ['$scope', '$state','$rootScope', '$routeParams', '$location', 'ngDialog',
    ...
    function (scope, $state, rootScope, routeParams, location, ngDialog, configUIService, resourceUIService, userInitService,
        ...
        var userEditClick = function (row, source) {
          ...
          scope.dialog = {
            ...
            input: [{
              ...
              })(clone.specialties),//只支持数组clone.specialties,
              "label": "专业",
              "data": "specialties",
              "type": "multiple",
            ...
            button: [{
              ...
              fn: function () {
                ...
                if (errorStatus == -1) {
                  ...
                  obj.domainID = oldUser.domainID == getDomainId(row.domainPath )
                    ? null : oldUser.domainID;

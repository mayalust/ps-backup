        ...
        var ready = function () {
          ...
          var ngModelWatcher = function (n, o, s) {
            ...
            var render = function (data, type, searchlist) {
              var tree = data, searchFound = (type == "search") ? false : true;
              ...
              var traverse = function (target, data, depth, parentIcon, parentRmvBtn, parentDom, parentUser, parentData) {
                ...
                var addClick = function (event) {
                  ...
                  var confirm = function (event) {
                    ...
                    // 新增加的序号
                    var number = event.input[1].value - 0;
                    // 新增加的编码
                ...
                var removeClick = function () {
                  ...
                  // 300 是管理域
                  if(data.modelId == 302){ //如果是项目域  （区域信息）  modelId 30
                    projectUIService.findProjectsByCondition({"orCondition":"","domainPath":"","projectName":data.name},function (r) {
                  ...
                  }else if (data.modelId == 301){ 2//如果是客户域  （产线信息） modelId 301
                    customerUIService.findCustomersByCondition({"id":data.id,"orCondition":"","customerName":"","customerAddress":"","domainPath":"","customerPhone":""},function (res) {

...
var config = {
  ...
  paths: {
    ...
    'jasmine-standalone' : "../../toolkit/jasmine-standalone-2.9.1/lib/jasmine.js",
    'jasmine-standalone' : "../../toolkit/jasmine-standalone-2.9.1/lib/jasmine.js"
  },
  shim: {
    'ace' : { exports:'ace'},
  ...
  deps: ['tools', 'Array', 'slimscroll', 'jquery-ui', 'index-app', 'bootstrap-multiselect', 'contextmenu', 'loader', 'configs']
}

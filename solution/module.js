define(['angular', '../solution/module.config.js', '../js/directives/data-tables-adv-dom.js', '../js/directives/ps-tree-dom.js'], function(angular, config){
  ...
  function getResource(path, e){
    ...
    //return e != "controller" ? "../../solution/" + path + "/" + e : "../../release/" + path + "/" + e;
  }

define(
  ...
  function(app, dom, codeMirror, profile, commonlib) {
    ...
    app.controller("mainController", [
      "$scope", "$rootScope", "$window", "$timeout", "styleList", "timeformatList", "toolBarList", "optionType", "loginManagement", "dataManagement", "userInfo", "units", "viewFlexService", "solutionUIService", "resourceUIService",
      function(scope, rootScope, window, timeout, styleList, timeformatList, toolBarList, optionType, lm, dm, userInfo, units, viewFlexService, solutionUIService, resourceUIService) {
        var currentTarget;
        var viewId;

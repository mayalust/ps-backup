define(['controllers/controllers', 'bootstrap-dialog'], function (controllers, BootstrapDialog) {
  'use strict';
  //预览
  controllers.initController('expensesPreviewCtrl', ['$scope', "$sce", 'chargeUIService', 'kpiDataService', 'userLoginUIService', 'resourceUIService', 'psMessageService', 'growl',
  ...
  //缴费记录
  controllers.initController('expensesRecordCtrl', ['$scope', 'chargeUIService', 'userLoginUIService', 'userEnterpriseService', 'growl', 'resourceUIService',
  ...
  //续费
  controllers.initController('expensesRenewCtrl', ['$scope', "$sce", '$routeParams', 'chargeUIService', 'userLoginUIService', 'resourceUIService', 'psMessageService', 'growl',
